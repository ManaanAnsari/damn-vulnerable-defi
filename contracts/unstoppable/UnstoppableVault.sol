...
// @audit - whats erc4626? and IERC3156FlashLender?
contract UnstoppableVault is IERC3156FlashLender, ReentrancyGuard, Owned, ERC4626 {
    ...
    function totalAssets() public view override returns (uint256) {
        // @audit - what is this? y assembly code?
        assembly {
        ...
        returns (bool)
    {
        ...
        if (
            receiver
                // @audit - why are we checking this?
                .onFlashLoan(msg.sender, address(asset), amount, fee, data)
